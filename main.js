...
const openedCookieScreen = document.querySelector('.sorte');
...
//Events
cookie.addEventListener('click', handleClickButtonCookie);
openAnotherCookieButton.addEventListener('click', handleClickButton);

//Functions that handle clicks.
function handleClickButtonCookie() {
  setRandomPhrase();
...
function activeToggle() {
  ...
  openedCookieScreen.classList.toggle('hidden');
}
